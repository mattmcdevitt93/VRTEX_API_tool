...
class TimesheetsControllerTest < ActionController::TestCase
  ...
  test "should create timesheet" do
    assert_difference('Timesheet.count') do
      post :create, timesheet: { event: @timesheet.event, event_time: @timesheet.event_time, notes: @timesheet.notes, urgency: @timesheet.urgency, user_id: @timesheet.user_id }
    end
  ...
  test "should update timesheet" do
    patch :update, id: @timesheet, timesheet: { event: @timesheet.event, event_time: @timesheet.event_time, notes: @timesheet.notes, urgency: @timesheet.urgency, user_id: @timesheet.user_id }
    assert_redirected_to timesheet_path(assigns(:timesheet))
  end
