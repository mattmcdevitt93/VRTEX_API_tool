Rails.application.configure do
  ...
  ActionMailer::Base.smtp_settings = { :address => "smtp.gmail.com", :port => 587, :authentication => :plain, :domain => 'gmail.com', :user_name => ENV["RECOVERY_EMAIL"], :password => ENV["RECOVERY_PASSWORD"] }
end
